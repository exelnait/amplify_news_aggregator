...
class ArticleContentItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // } else
      if (newsBlock is TextParagraphBlock) {
      return TextParagraph(block: newsBlock, onUrlTap: openUrl,);
